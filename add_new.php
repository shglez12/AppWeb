...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `datos_pacientes`(`id`, `nombre`, `apellidos`, `sexo`, `edad`, `especialidad`)
    VALUES (NULL,'$nombre','$apellidos','$sexo','$edad','$especialidad')";

    $result = mysqli_query($conn, $sql);

    if($result){
        header("Location:index.php?msg=Nuevo registro creado correctamente");
    }else{
...
<nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color:  #000000"  >
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Completa el formulario para agregar un nuevo paciente</p>
        </div>
    </div>
